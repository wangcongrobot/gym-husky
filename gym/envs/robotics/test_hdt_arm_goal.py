...
env = gym.make("HDTArmPickAndPlaceGoal-v1")
...
print("gripper body quat: ", env.sim.data.get_body_xquat("r_gripper_palm_link")) 
...
#     action = np.array([0.1, 0.0, 0.0, 0.5]) # 1.0 open -1.0 close
#     action[-1] = -1.0
    # if action[-1] > 1.0:
          # action[-1] = -1.0
